...
%state         CHILD_WAITING_STRING
%state             CHILD_WAITING_STRING_CHILD_OR_END, __CHILD_WAITING_STRING_CHILD_OR_END
...
<WAITING_SEPARATOR_OR_CHILD_OR_END> {SEPARATOR}             { yybegin(WAITING_STRING); return RnTypes.SEPARATOR; }
...
<WAITING_STRING> {FIRST_MUILTILINE_STRING_CHARACTER}({MUILTILINE_STRING}*){LAST_MUILTILINE_STRING_CHARACTER} { yybegin(WAITING_CHILD_OR_END); return RnTypes.STRING; }
<WAITING_STRING> {FIRST_STRING_CHARACTER}({STRING}*)        { yybegin(WAITING_CHILD_OR_END); return RnTypes.STRING; }
...
<CHILD_WAITING_SEPARATOR_OR_CHILD_OR_END> {END}{WHITE_SPACE}+  { return waiting_child_or_end(__CHILD_WAITING_STRING_CHILD_OR_END, CHILD_WAITING_KEY); }
<CHILD_WAITING_SEPARATOR_OR_CHILD_OR_END> {END}                { return waiting_child_end(CHILD_WAITING_CHILD_OR_END, WAITING_END_LINE); }

<CHILD_WAITING_STRING> {FIRST_MUILTILINE_STRING_CHARACTER}({MUILTILINE_STRING}*){LAST_MUILTILINE_STRING_CHARACTER} { yybegin(CHILD_WAITING_STRING_CHILD_OR_END); return RnTypes.STRING; }
<CHILD_WAITING_STRING> {FIRST_STRING_CHARACTER}({STRING}*)     { yybegin(CHILD_WAITING_STRING_CHILD_OR_END); return RnTypes.STRING; }
<CHILD_WAITING_STRING_CHILD_OR_END> {END}{WHITE_SPACE}+        { return waiting_child_or_end(__CHILD_WAITING_STRING_CHILD_OR_END, CHILD_WAITING_KEY); }
<CHILD_WAITING_STRING_CHILD_OR_END> {END}                      { return waiting_child_end(__CHILD_WAITING_CHILD_OR_END, WAITING_END_LINE); }
<__CHILD_WAITING_STRING_CHILD_OR_END> {END}{WHITE_SPACE}+      { return waiting_child_or_end(CHILD_WAITING_STRING_CHILD_OR_END, CHILD_WAITING_KEY); }
<__CHILD_WAITING_STRING_CHILD_OR_END> {END}                    { return waiting_child_end(CHILD_WAITING_STRING_CHILD_OR_END, WAITING_END_LINE); }
